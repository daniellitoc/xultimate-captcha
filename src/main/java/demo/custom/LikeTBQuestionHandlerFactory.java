...
public class LikeTBQuestionHandlerFactory implements FactoryBean<DeformedComposedQuestionHandler<String>> {
	...
	public DeformedComposedQuestionHandler<String> getObject() throws Exception {
		...
		textQuestionHandler.setGlyphsVisitors(new GlyphsVisitors[] { new TranslateGlyphsVerticalRandomVisitor(0.7),  new OverlapGlyphsUsingShapeVisitor(1.5), new TranslateAllToRandomPointVisitor() });
        ...
        UniColorBackgroundGenerator backgroundGenerator = new UniColorBackgroundGenerator(new Color[] { Color.WHITE } );
