 ...
 */
public class FuckyBackgroundGenerator implements BackgroundGenerator {
	
	protected Color[] leftUpColors;
	protected Color[] leftDownColors;
	protected Color[] rightUpColors;
	protected Color[] rightDownColors;
	protected float perturbationlevel;
    
    public FuckyBackgroundGenerator() {
		this(new Color[] { Color.YELLOW }, new Color[] { Color.RED }, new Color[] { Color.YELLOW }, new Color[] { Color.GREEN }, 0.1f);
	}
    
    public FuckyBackgroundGenerator(Color[] leftUpColors, Color[] leftDownColors, Color[] rightUpColors, Color[] rightDownColors, float perturbationlevel) {
