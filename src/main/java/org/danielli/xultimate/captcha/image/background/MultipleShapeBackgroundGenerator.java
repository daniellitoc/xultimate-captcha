 ...
 */
public class MultipleShapeBackgroundGenerator implements BackgroundGenerator {

	protected Color firstEllipseColor;
	protected Color secondEllipseColor;
	protected int spaceBetweenLine;
	protected int spaceBetweenCircle;
	protected int ellipseHeight;
	protected int ellipseWidth;
	
	protected Color firstRectangleColor;
	protected Color secondRectangleColor;
	...
	public MultipleShapeBackgroundGenerator(Color firstEllipseColor, Color secondEllipseColor, Integer spaceBetweenLine, Integer spaceBetweenCircle, Integer ellipseHeight, Integer ellipseWidth, Color firstRectangleColor, Color secondRectangleColor, Integer rectangleWidth) {
